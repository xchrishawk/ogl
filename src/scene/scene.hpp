...
namespace ogl
{
  ...
  public:
    ...
    std::vector<directional_light> directional_lights() const { return m_directional_lights; }

    /** Sets the directional lights in the scene. */
    void set_directional_lights(const std::vector<directional_light>& lights) { m_directional_lights = lights; }
