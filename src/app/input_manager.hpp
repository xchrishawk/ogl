...
namespace ogl
{
  ...
  enum input_key
  {
    ...
    INPUT_KEY_CONTROL_MODE_CAMERA,
    INPUT_KEY_CONTROL_MODE_OBJECT,
    INPUT_KEY_CONTROL_OBJECT_CYCLE,
    INPUT_KEY_CAMERA_RESET,
    INPUT_KEY_TRANSLATE_FORWARD,
    INPUT_KEY_TRANSLATE_BACKWARD,
    INPUT_KEY_TRANSLATE_RIGHT,
    INPUT_KEY_TRANSLATE_LEFT,
    INPUT_KEY_TRANSLATE_UP,
    INPUT_KEY_TRANSLATE_DOWN,
    INPUT_KEY_ROTATE_PITCH_UP,
    INPUT_KEY_ROTATE_PITCH_DOWN,
    INPUT_KEY_ROTATE_ROLL_RIGHT,
    INPUT_KEY_ROTATE_ROLL_LEFT,
    INPUT_KEY_ROTATE_YAW_RIGHT,
    INPUT_KEY_ROTATE_YAW_LEFT,
    INPUT_KEY_SCALE_UP,
    INPUT_KEY_SCALE_DOWN,

    INPUT_KEY_COUNT,
    INPUT_KEY_FIRST_VALID = INPUT_KEY_APPLICATION_EXIT,
    INPUT_KEY_LAST_VALID = INPUT_KEY_SCALE_DOWN,
  };
